<template>
  <div class="w-full md:w-1/3 px-4 pb-12">
    <div class="border border-solid h-full bg-white rounded overflow-hidden shadow-sm hover:shadow-md relative smooth">
      <nuxt-link :to="`/blogs/${slug}`" class="no-underline hover:no-underline">
        ...
        <img v-if="!image" src="~assets/images/default.svg" height="192" class="h-48 w-full rounded-t" />
